...
% In examining, apprenticeships as a valuable learning model, \citet{papert_mindstorms_1980} uses as the example of the Brazilian Samba schools. These schools allow both novices and experts to learn from one another by building on one another's work and expertise in an ad-hoc fashion.
...
More especially on online communities for remixing, \citet{shaw_community_2006} developed a video remixing platform and studied the nature of the most generative video segments intending to understand how to integrate automatic recommendation systems with user-driven suggestions.
